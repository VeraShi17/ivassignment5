...
import assignment5_styles from "/src/styles/assignment5_styles.module.css";
...
function AirlineRoutes(){
    ...
    return <Container >
        ...
        <Col lg={4}>
            <h2>Airlines</h2>
            <svg id={"barchart"} width={barchart_width} height={barchart_height} className={assignment5_styles.svgStyle}>
        ...
        <Col lg={4} >
            <h2>Airports</h2>
            <svg id={"map"} width={map_width} height={map_height} className={assignment5_styles.svgStyle}>
